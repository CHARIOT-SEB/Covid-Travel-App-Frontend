	...
	return (
		<SafeAreaView>
			<View style={styles.container}>
				...
				<TouchableOpacity style={styles.button} onPress={() => nav.navigate('IndividualCountry')}>
					...
					<FlatList
						...
						renderItem={({ item }) => (
							<View style={styles.singleTrip}>
								...
								>
									<Text style={[styles.listItem, styles.countryName]}>{item.country}</Text>
								</View>
								...
								<View style={styles.listItem}>
									...
									<Ionicons
										name={item.acceptingTourists ? 'md-checkmark-circle' : 'md-close-circle'}
										size={20}
								...
								<View style={styles.listItem}>
									...
									<Ionicons
										name={item.testRequired ? 'md-checkmark-circle' : 'md-close-circle'}
										size={20}
								...
								<View style={styles.listItem}>
									...
									<Ionicons
										name={item.vaccineRequired ? 'md-checkmark-circle' : 'md-close-circle'}
										size={20}
								...
								<View style={styles.listItem}>
									...
									<Ionicons
										name={item.docsRequired ? 'md-checkmark-circle' : 'md-close-circle'}
										size={20}
