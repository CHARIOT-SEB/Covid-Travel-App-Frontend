...
const SignUpForm = (props: any) => {
	...
	const { isLoggedIn, setSignUp, setUser, user, setLoginInfo, setIsLoggedIn } =
	...
	return (
		<SafeAreaView style={styles.container}>
			...
			<View style={styles.formContainer}>
				...
				<View>
					<TouchableOpacity style={styles.btn} onPress={() => {nav.navigate('Home'); console.log('clicking home button');}}>
